...
public class ChessMatch {
	...
	private Piece makeMove(Position source, Position target) { // Move a peça da origem pro destino
		...
		if (capturedPiece != null) { // retira da lista de peça do tabuleiro e adiciona nas capturadas, caso tenha
										// peça capturada
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) { // Desfaz um movimento que foi feito
																					// para deixar seu rei em cheque
	...
	private ChessPiece king(Color color) { // retorna o rei do oponente
		...
		throw new IllegalStateException("There is no " + color + " king on the board"); // caso não ache o rei do
																						// oponente gera um exeção,visto
																						// que quando o rei não está no
																						// tabuleiro o jogo acabou
	}
